...
/***/ function(module, exports, __webpack_require__) {
	...
	/* REACT HOT LOADER */ if (false) { (function () { var ReactHotAPI = require("/home/duanhong/qiantai_demo/frontend/node_modules/react-hot-loader/node_modules/react-hot-api/modules/index.js"), RootInstanceProvider = require("/home/duanhong/qiantai_demo/frontend/node_modules/react-hot-loader/RootInstanceProvider.js"), ReactMount = require("react/lib/ReactMount"); module.makeHot = module.hot.data ? module.hot.data.makeHot : ReactHotAPI(function () { return RootInstanceProvider.getRootInstances(ReactMount); }); })(); }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1),
	    $__0=   __webpack_require__(5),Route=$__0.Route,DefaultRoute=$__0.DefaultRoute;

	var Intro = __webpack_require__(32);
	var Home = __webpack_require__(33);
	var Index = __webpack_require__(34);
	var Detail = __webpack_require__(35);
	...
	module.exports = (
	    React.createElement(Route, {handler: Index, path: "/"}, 
	        ...
	        React.createElement(Route, {handler: Home, name: "home"}), 
	        React.createElement(Route, {handler: Result, name: "result"}), 
	        React.createElement(Route, {handler: Detail, name: "detail", path: "/:id"})
	    )
	);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Index = React.createClass({displayName: "Index",
	    ...
	    render: function(){
	        return React.createElement("div", {className: "intro"}, 
	            React.createElement("p", {className: "app-title text-center text-info"}, "滴滴打油"), 
	            React.createElement("div", {className: "app-logo"}, 
	                React.createElement("img", {src: "/static/img/logo.png", alt: "logo"})
	            ), 
	            React.createElement("div", {className: "footer"}, 
	                React.createElement("p", {className: "app-desc text-center text-info"}, "地沟油售卖平台第一家！"), 
	                React.createElement(Link, {className: "btn btn-block btn-info text-center alert-bar", to: "home"}, 
	                    "立即体验"
	                ), 
	                React.createElement("p", {className: "app-ver text-center text-info"}, "1.0")
	            )
	        )
	    }
	});
	...
	/* REACT HOT LOADER */ if (false) { (function () { module.hot.dispose(function (data) { data.makeHot = module.makeHot; }); if (module.exports && module.makeHot) { var makeExportsHot = require("/home/duanhong/qiantai_demo/frontend/node_modules/react-hot-loader/makeExportsHot.js"), foundReactClasses = false; if (makeExportsHot(module)) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "intro.js" + ": " + err.message); } }); } } })(); }
	...
	var Home = React.createClass({displayName: "Home",
	    ...
	    render: function(){
	        ...
	        return React.createElement("div", {className: "home"}, 
	            ...
	            React.createElement("div", {className: "note alert-bar"}, 
	                React.createElement("p", {className: "msg text-center"}, "热烈庆祝滴滴打油师融资2亿美金！"), 
	                React.createElement("p", {className: "msg text-center"}, "首单任一油品1毛包邮！")
	            ), 
	            React.createElement("div", {className: "list", ref: "list"}, 
	            
	                items.map(function(item, index){
	                    return React.createElement(Link, {className: "list-item table clearfix", to: "detail", params: item}, 
	                       React.createElement("div", {className: "table-cell"}, 
	                        React.createElement("img", {src: item.avatar, className: "avatar"})
	                       ), 
	                       React.createElement("div", {className: "table-cell" + ((index === (items.length-1)) ? ' last':'')}, 
	                        React.createElement("span", {className: "row name"}, item.name), 
	                        React.createElement("span", {className: "row info"}, 
	                            React.createElement("span", {className: "order-count label"}, "本月接单:", item.orders_count), 
	                            React.createElement("span", {className: "rating label"}, "评分:", item.rating)
	                        ), 
	                        React.createElement("span", {className: "row desc"}, item.desc)
	                       )
	                    )
	                }), 
	            
	            React.createElement("div", {className: "loading table"}, 
	                React.createElement("span", {className: "table-cell"}, 
	                    React.createElement("img", {src: "/static/img/indicator.png", className: "loading-img"})
	                ), 
	                React.createElement("span", {className: "table-cell loading-text"}, 
	                    React.createElement("span", {className: "row"}, "客官请稍等片刻"), 
	                    React.createElement("span", {className: "row"}, "更多打油师正在赶来...")
	                )
	            )
	            )
	        )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var TransitionGroup = __webpack_require__(113);
	var $__0=     __webpack_require__(5),Link=$__0.Link,RouteHandler=$__0.RouteHandler,State=$__0.State;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var Api = __webpack_require__(112);
	var $__0=      __webpack_require__(5),State=$__0.State,Navigation=$__0.Navigation,Link=$__0.Link;
	...
	var Detail = React.createClass({displayName: "Detail",
	    ...
	    render: function(){
	        ...
	        return React.createElement("div", {className: "detail"}, 
	            React.createElement("div", {className: "fixed-top text-center header"}, 
	                React.createElement(Link, {to: "home", className: "back-link"}, React.createElement("img", {className: "back", src: "/static/img/back.svg", onClick: that.transitionTo.bind(that, 'home')})), 
	                React.createElement("span", null, item.name)
	            ), 
	            React.createElement("div", {className: "user table", style: {backgroundImage: 'url(' + item.bg + ')'}}, 
	                React.createElement("span", {className: "table-cell"}, 
	                    React.createElement("img", {src: item.avatar, className: "avatar"})
	                ), 
	                React.createElement("span", {className: "table-cell"}, 
	                    React.createElement("span", {className: "row name"}, item.name), 
	                    React.createElement("span", {className: "row order-count"}, "本月接单: ", item.orders_count), 
	                    React.createElement("span", {className: "row rating"}, "综合评分: ", item.rating)
	                )
	            ), 
	            React.createElement("div", {className: "well"}, 
	                React.createElement("span", {className: "row title"}, "打油师简介"), 
	                React.createElement("p", {className: "content"}, item.detail), 
	                React.createElement("span", {className: "row title"}, "个人宣言"), 
	                React.createElement("p", {className: "content"}, item.quota)
	            ), 
	            React.createElement("div", {className: "panel"}, 
	                React.createElement("img", {className: "panel-img", src: product.img}), 
	                React.createElement("span", {className: "row name"}, product.name, React.createElement("span", {className: "right"}, product.price, "元")), 
	                React.createElement("p", {className: "content"}, product.desc), 
	                React.createElement("p", {className: "info text-center"}, "使用钱台交易云，1毛钱体验滴滴打油")
	            ), 
	            React.createElement("button", {className: "btn btn-block btn-red alert-bar note", onClick: that.createOrder}, submitting ?  '正在提交':'立即订购')
	        )
	    }
	});
	...
	/* REACT HOT LOADER */ if (false) { (function () { module.hot.dispose(function (data) { data.makeHot = module.makeHot; }); if (module.exports && module.makeHot) { var makeExportsHot = require("/home/duanhong/qiantai_demo/frontend/node_modules/react-hot-loader/makeExportsHot.js"), foundReactClasses = false; if (makeExportsHot(module)) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "detail.js" + ": " + err.message); } }); } } })(); }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var $__0=      __webpack_require__(5),Link=$__0.Link,State=$__0.State,Navigation=$__0.Navigation,RouteHandler=$__0.RouteHandler;
	var Api = __webpack_require__(112);
	...
	var Result = React.createClass({displayName: "Result",
	    ...
	    render: function(){
	        ...
	        return React.createElement("div", {className: "result"}, 
	            React.createElement("div", {className: "fixed-top text-center header"}, 
	                React.createElement(Link, {to: "home", className: "back-link"}, React.createElement("img", {className: "back", src: "/static/img/back.svg", onClick: that.transitionTo.bind(that,'home')})), 
	                React.createElement("span", null, "订单: ", decodeURIComponent(state.goods_name))
	            ), 
	            React.createElement("div", {className: "note alert-bar"}, 
	                React.createElement("p", {className: "msg text-center"}, "感谢钱台交易云提供的支付服务！")
	            ), 
	            React.createElement("div", {className: "notice"}, 
	                React.createElement("p", {className: classes}, state.status == 2 ? '交易成功':'交易失败'), 
	                React.createElement("p", {className: "info text-center"}, 
	                    "滴滴打油纯属虚构，钱台支付绝对靠谱！"
	                )
	            ), 
	            React.createElement("div", {className: "footer"}, 
	                React.createElement("a", {className: "info text-center", target: "_blank", href: "http://mp.weixin.qq.com/s?__biz=MzA4NTA3OTc2OA==&mid=202715497&idx=1&sn=31f29950348d53cbf284bf310df8bcb3#wechat_redirect"}, 
	                    "钱台交易云，让交易更简单。"
	                ), 
	                React.createElement("button", {className: "btn btn-block btn-info btn-share text-center", onClick: that.shareWX}, 
	                    React.createElement("span", {className: "row text-center"}, "立即分享")
	                )
	            ), 
	            that.state.sharing ? React.createElement("div", {className: "share fade-enter", ref: "share", onClick: that.shareWX}, 
	                React.createElement("div", {className: "share-img"}
	                )
	            ) : false
	        )
	    }
	...
	/* REACT HOT LOADER */ if (false) { (function () { module.hot.dispose(function (data) { data.makeHot = module.makeHot; }); if (module.exports && module.makeHot) { var makeExportsHot = require("/home/duanhong/qiantai_demo/frontend/node_modules/react-hot-loader/makeExportsHot.js"), foundReactClasses = false; if (makeExportsHot(module)) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "result.js" + ": " + err.message); } }); } } })(); }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var FakeNode = __webpack_require__(114);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var classSet = __webpack_require__(116);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var RouteHandlerMixin = __webpack_require__(117);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LocationActions = __webpack_require__(118);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NavigationContext = __webpack_require__(120);
	var StateContext = __webpack_require__(121);
	var Scrolling = __webpack_require__(122);
	var createRoutesFromChildren = __webpack_require__(123);
	            ...
	            .end(function(err, res) {
	                if (!err) {
	                    ...
	                    if (resp.respcd === '0000') {
	                        ...
	                        if (window.wx) {
	                            resp.data.appid = 'wx236561fae69fd472';
	                            wx.config(resp.data);
	                            var share_data = {
	                                ...
	                                imgUrl: location.host + '/static/img/logo.png'
	                            };
	                            wx.ready(function() {
	                                // 2. 分享接口
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		module.hot.accept("!!/home/duanhong/qiantai_demo/frontend/node_modules/css-loader/index.js!/home/duanhong/qiantai_demo/frontend/node_modules/less-loader/index.js!/home/duanhong/qiantai_demo/frontend/less/app.less", function() {
			var newContent = require("!!/home/duanhong/qiantai_demo/frontend/node_modules/css-loader/index.js!/home/duanhong/qiantai_demo/frontend/node_modules/less-loader/index.js!/home/duanhong/qiantai_demo/frontend/less/app.less");
